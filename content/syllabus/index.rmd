...
If you come into class without preparing, things will feel bad! Before you come to class Monday, you should (1) watch the video lecture (15-30 minutes usually) and (2) earn at least an 80% on that week's lecture quiz. 

## Lectures and practice (M/W/F) {#class-meetings-m .unnumbered}

Our class meetings will be a combination of lecture, practice, and labs. 

We will not have labs every week, but when we do, they will be on Wednesdays. During labs you should bring a laptop to class. I will demo some concepts and commands and give you time to practice. A final version of your [lab](/assignment#labs) will be due before the next Monday class.


# Deadlines  {#deadlines-and-extensions .unnumbered}

-   All deadlines are at 1:10pm, and all assignments are due on Blackboard.

-   As a general rule, problem sets are due on Fridays at 1:10pm. Video
    quizzes and final labs are due on Mondays at 1:10pm.

-   Please submit all assignments through Blackboard. If you encounter
    technical issues, e-mail is a fine last resort.

-   Late problem sets and labs will be penalized 10 percentage points per day. 

-   Regarding **research papers elements *only***, I have an *"extensions for all"* policy
  - If you need an extension, request it by e-mail **before** the deadline and provide proposed     new deadline. 
...
There are two unit quizzes (15% each) and one stats quiz (5%). All quizzes are in-class and open note, but computers will not be permitted. 
