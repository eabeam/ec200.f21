...
See the exercises below, or you can [download them as a pdf](../04-ps.pdf). You can download the data file you need for question 6 [here](../materials/growth.dta), along with information on the variable definitions [here](https://www.princeton.edu/~mwatson/Stock-Watson_3u/Students/EE_Datasets/Growth_Description.pdf)
